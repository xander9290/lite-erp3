              ...
              <Row>
                ...
                <FormViewGroup>
                  <FieldRelation
                    ...
                    readonly={getValues().state !== "purchase"}
                  />
                </FormViewGroup>
              </Row>
              <Row>
                  ...
                  <SimpleTable
                    ...
                    renderRow={(row, index) => (
                      <tr key={row.id} className="border-bottom">
                        ...
                        <SimpleTD colIdx={index} name="operatioPendingQty">
                          <FieldEntry inline type="number" decimals={3} name={`OrderLines.${index}.pendingQty`} readonly />
                        </SimpleTD>
                        <SimpleTD colIdx={index} name="operationReceivedQty">
                          <FieldEntry inline type="number" decimals={3} name={`OrderLines.${index}.receivedQty`} readonly={getValues().OrderLines[index].state !== "pending"} />
                        </SimpleTD>
                        <SimpleTD colIdx={index} name="operationReady" contentPosition="text-center">
                          <FieldBoolean inline name={`OrderLines.${index}.ready`} readonly={getValues().OrderLines[index].state !== "pending"} />
                        </SimpleTD>
                      </tr>
                    )}
                  />
