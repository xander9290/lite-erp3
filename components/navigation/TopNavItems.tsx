...
function TopNavItems() {
  ...
  return (
    <>
      ...
      >
        <NavDropdown.Item title="saleQuotsMenu" disabled={fieldsAccess.find((field) => field.fieldName === "saleQuotsMenu")?.invisible}>
          Cotizaciones
        </NavDropdown.Item>
        <NavDropdown.Item title="saleSalesMenu" disabled={fieldsAccess.find((field) => field.fieldName === "saleSalesMenu")?.invisible}>
          Órdenes
        </NavDropdown.Item>
      </NavDropdown>
      <NavDropdown
