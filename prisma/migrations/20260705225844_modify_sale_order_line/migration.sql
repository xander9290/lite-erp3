/*
  ...
  - The values [cancled] on the enum `SaleOrderLineState` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "SaleOrderLineState_new" AS ENUM ('pending', 'reserved', 'delivered', 'invoiced', 'cancel');
